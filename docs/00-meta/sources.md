...
Public references used to check definitions and common heuristics. This is not a trade-idea feed.

!!! danger "Not financial advice"
    Sources are for education and verification of mechanics — not recommendations.

## Tags on this site

| Tag | Meaning |
|-----|---------|
| `[verified]` | Consistent with ≥2 independent reputable sources, or a primary broker page for that claim |
...
- OCC *Characteristics and Risks of Standardized Options* (usually via your broker)

## Greeks and event volatility
...
Retail options risk writeups commonly discuss about **1–2% of equity** max loss per defined-risk trade and aggregate “heat” bands often nearer **10–15%**. Treat those as comparison points for your own written policy — not as advice.
